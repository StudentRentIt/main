...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Event.heading'
        db.delete_column('school_event', 'heading')

        # Deleting field 'Deal.heading'
        db.delete_column('school_deal', 'heading')


    def backwards(self, orm):
        # Adding field 'Event.heading'
        db.add_column('school_event', 'heading',
                      self.gf('django.db.models.fields.CharField')(null=True, blank=True, max_length=200),
                      keep_default=False)

        # Adding field 'Deal.heading'
        db.add_column('school_deal', 'heading',
                      self.gf('django.db.models.fields.CharField')(null=True, blank=True, max_length=200),
                      keep_default=False)
