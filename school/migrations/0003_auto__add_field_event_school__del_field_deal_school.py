...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('school_event', 'school',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['school.School'], default=2),
                      keep_default=False)

        # Deleting field 'Deal.school'
        db.delete_column('school_deal', 'school_id')


    def backwards(self, orm):
        # Deleting field 'Event.school'
        db.delete_column('school_event', 'school_id')


        # User chose to not deal with backwards NULL issues for 'Deal.school'
        raise RuntimeError("Cannot reverse this migration. 'Deal.school' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Deal.school'
        db.add_column('school_deal', 'school',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['school.School']),
                      keep_default=False)
    ...
    models = {
        ...
        'property.package': {
            ...
            'services': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['property.Service']", 'symmetrical': 'False', 'null': 'True', 'blank': 'True'}),
        ...
        'property.property': {
            ...
            'amenities': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['property.Amenity']", 'symmetrical': 'False', 'null': 'True', 'blank': 'True'}),
            ...
            'lease_term': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['property.PropertyLeaseTerm']", 'symmetrical': 'False', 'null': 'True', 'blank': 'True'}),
            'lease_type': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['property.PropertyLeaseType']", 'symmetrical': 'False', 'null': 'True', 'blank': 'True'}),
