...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Deal.school'
        db.add_column('school_deal', 'school',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['school.School'], default=1),
                      keep_default=False)

        # Adding field 'Deal.heading'
        db.add_column('school_deal', 'heading',
                      self.gf('django.db.models.fields.CharField')(blank=True, max_length=60, null=True),
                      keep_default=False)
    ...
    models = {
        ...
        'school.deal': {
            ...
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {}),
            'heading': ('django.db.models.fields.CharField', [], {'blank': 'True', 'max_length': '60', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'blank': 'True', 'max_length': '100', 'null': 'True'}),
