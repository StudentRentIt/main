...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Group'
        db.create_table('search_group', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=30)),
        ))
        db.send_create_signal('search', ['Group'])

        # Adding model 'GroupMember'
        db.create_table('search_groupmember', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('search', ['GroupMember'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('search_group')

        # Deleting model 'GroupMember'
        db.delete_table('search_groupmember')
