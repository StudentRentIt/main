...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GroupProperty'
        db.create_table('search_groupproperty', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('property', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['property.Property'])),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['search.Group'])),
        ))
        db.send_create_signal('search', ['GroupProperty'])

        # Adding unique constraint on 'GroupProperty', fields ['property', 'group']
        db.create_unique('search_groupproperty', ['property_id', 'group_id'])

        # Adding field 'Comment.group_property'
        db.add_column('search_comment', 'group_property',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['search.GroupProperty'], default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'GroupProperty', fields ['property', 'group']
        db.delete_unique('search_groupproperty', ['property_id', 'group_id'])

        # Deleting model 'GroupProperty'
        db.delete_table('search_groupproperty')

        # Deleting field 'Comment.group_property'
        db.delete_column('search_comment', 'group_property_id')
    ...
    models = {
        ...
        'property.package': {
            ...
            'services': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'null': 'True', 'symmetrical': 'False', 'to': "orm['property.Service']"}),
        ...
        'property.property': {
            ...
            'amenities': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'null': 'True', 'symmetrical': 'False', 'to': "orm['property.Amenity']"}),
            ...
            'lease_term': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'null': 'True', 'symmetrical': 'False', 'to': "orm['property.PropertyLeaseTerm']"}),
            'lease_type': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'null': 'True', 'symmetrical': 'False', 'to': "orm['property.PropertyLeaseType']"}),
            ...
            'rating': ('django.db.models.fields.DecimalField', [], {'blank': 'True', 'decimal_places': '1', 'max_digits': '3', 'null': 'True'}),
        ...
        'search.groupmember': {
            'Meta': {'object_name': 'GroupMember', 'unique_together': "(('user', 'group'),)"},
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['search.Group']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
        'search.groupproperty': {
            'Meta': {'object_name': 'GroupProperty', 'unique_together': "(('property', 'group'),)"},
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['search.Group']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
