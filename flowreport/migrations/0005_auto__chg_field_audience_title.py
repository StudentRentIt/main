...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Audience.title'
        db.alter_column('flowreport_audience', 'title', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'Audience.title'
        db.alter_column('flowreport_audience', 'title', self.gf('django.db.models.fields.CharField')(max_length=1))
    ...
    models = {
        ...
        'flowreport.report': {
            ...
            'audience': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['flowreport.Audience']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'}),
        ...
        'main.property': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lat': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'blank': 'True', 'max_digits': '12', 'decimal_places': '6'}),
            ...
            'long': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'blank': 'True', 'max_digits': '12', 'decimal_places': '6'}),
            'school': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.School']"}),
