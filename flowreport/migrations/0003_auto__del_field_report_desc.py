...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Report.desc'
        raise RuntimeError("Cannot reverse this migration. 'Report.desc' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Report.desc'
