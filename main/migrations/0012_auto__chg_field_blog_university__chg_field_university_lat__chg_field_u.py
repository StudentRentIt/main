...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Blog.university'
        db.alter_column(u'main_blog', 'university_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.University'], null=True))

        # Changing field 'University.lat'
        db.alter_column(u'main_university', 'lat', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=3))

        # Changing field 'University.long'
        db.alter_column(u'main_university', 'long', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=3))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Blog.university'
        raise RuntimeError("Cannot reverse this migration. 'Blog.university' and its values cannot be restored.")

        # Changing field 'University.lat'
        db.alter_column(u'main_university', 'lat', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2))

        # Changing field 'University.long'
        db.alter_column(u'main_university', 'long', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2))
    ...
    models = {
        ...
        u'main.blog': {
            ...
            'university': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.University']", 'null': 'True'})
        },
        u'main.faq': {
