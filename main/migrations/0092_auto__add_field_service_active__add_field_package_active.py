...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('main_service', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Package.active'
        db.add_column('main_package', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('main_service', 'active')

        # Deleting field 'Package.active'
        db.delete_column('main_package', 'active')
