...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PropertySublease'
        db.create_table('main_propertysublease', (
        ...
        db.send_create_signal('main', ['PropertySublease'])


    def backwards(self, orm):
        # Deleting model 'PropertySublease'
        db.delete_table('main_propertysublease')
