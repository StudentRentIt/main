...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.pic'
        db.add_column('main_userprofile', 'pic',
                      self.gf('django.db.models.fields.files.ImageField')(blank=True, max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.pic'
        db.delete_column('main_userprofile', 'pic')
    ...
    models = {
        ...
        'property.property': {
            ...
            'rating': ('django.db.models.fields.DecimalField', [], {'blank': 'True', 'decimal_places': '1', 'null': 'True', 'max_digits': '3'}),
            'real_estate_company': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'null': 'True', 'to': "orm['realestate.Company']"}),
