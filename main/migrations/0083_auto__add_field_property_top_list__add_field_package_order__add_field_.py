...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Package.order'
        db.add_column('main_package', 'order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Package.similar_property_strength'
        db.add_column('main_package', 'similar_property_strength',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Package.order'
        db.delete_column('main_package', 'order')

        # Deleting field 'Package.similar_property_strength'
        db.delete_column('main_package', 'similar_property_strength')
    ...
    models = {
        ...
        'main.article': {
            ...
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'to': "orm['main.Tag']", 'null': 'True', 'symmetrical': 'False'}),
        ...
        'main.package': {
            ...
            'services': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'to': "orm['main.Service']", 'null': 'True', 'symmetrical': 'False'}),
        ...
        'main.property': {
            ...
            'amenities': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'to': "orm['main.Amenity']", 'null': 'True', 'symmetrical': 'False'}),
            ...
            'lease_term': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'to': "orm['main.PropertyLeaseTerm']", 'null': 'True', 'symmetrical': 'False'}),
            'lease_type': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'to': "orm['main.PropertyLeaseType']", 'null': 'True', 'symmetrical': 'False'}),
