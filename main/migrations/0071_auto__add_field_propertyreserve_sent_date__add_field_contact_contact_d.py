...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('main_propertyreserve', 'sent_date',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True, default=datetime.datetime(2014, 3, 5, 0, 0)),
                      keep_default=False)

        # Adding field 'Contact.contact_date'
        db.add_column('main_contact', 'contact_date',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True, default=datetime.datetime(2014, 3, 5, 0, 0)),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('main_contact', 'contact_date')
    ...
    models = {
        ...
        'main.property': {
            ...
            'lease_start': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['main.PropertyLeaseStart']", 'symmetrical': 'False', 'null': 'True', 'blank': 'True'}),
