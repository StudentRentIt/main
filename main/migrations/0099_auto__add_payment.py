...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('main_payment', (
            ...
            ('payment_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
    ...
    models = {
        ...
        'main.payment': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'package': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'blank': 'True', 'to': "orm['main.Package']", 'symmetrical': 'False'}),
