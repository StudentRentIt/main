...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PropertyRoom.available'
        db.delete_column('main_propertyroom', 'available')

        # Adding field 'PropertyRoom.lease_start'
        db.add_column('main_propertyroom', 'lease_start',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['main.PropertyLeaseStart']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Adding field 'PropertyRoom.available'
        db.add_column('main_propertyroom', 'available',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'PropertyRoom.lease_start'
        db.delete_column('main_propertyroom', 'lease_start_id')
    ...
    models = {
        ...
        'main.article': {
            ...
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'symmetrical': 'False', 'blank': 'True', 'to': "orm['main.Tag']"}),
        ...
        'main.property': {
            ...
            'amenities': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'symmetrical': 'False', 'blank': 'True', 'to': "orm['main.Amenity']"}),
            ...
            'lease_term': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'symmetrical': 'False', 'blank': 'True', 'to': "orm['main.PropertyLeaseTerm']"}),
            'lease_type': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'symmetrical': 'False', 'blank': 'True', 'to': "orm['main.PropertyLeaseType']"}),
