...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('main_school', 'city',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['main.City'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'School.city'
        db.delete_column('main_school', 'city_id')
