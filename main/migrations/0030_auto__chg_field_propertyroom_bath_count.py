...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PropertyRoom.bath_count'
        db.alter_column('main_propertyroom', 'bath_count', self.gf('django.db.models.fields.DecimalField')(decimal_places=1, max_digits=5))

    def backwards(self, orm):

        # Changing field 'PropertyRoom.bath_count'
        db.alter_column('main_propertyroom', 'bath_count', self.gf('django.db.models.fields.DecimalField')(decimal_places=1, max_digits=3))
    ...
    models = {
        ...
        'main.property': {
            ...
            'lat': ('django.db.models.fields.DecimalField', [], {'blank': 'True', 'decimal_places': '6', 'null': 'True', 'max_digits': '12'}),
            'long': ('django.db.models.fields.DecimalField', [], {'blank': 'True', 'decimal_places': '6', 'null': 'True', 'max_digits': '12'}),
        ...
        'main.propertyimage': {
            ...
            'property': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.Property']", 'related_name': "'Images'"})
        },
        'main.propertyroom': {
            ...
            'property': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.Property']", 'related_name': "'Rooms'"}),
