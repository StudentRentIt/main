...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('main_propertyleasestart', (
            ...
            ('lease_start', self.gf('django.db.models.fields.CharField')(null=True, blank=True, max_length=3)),
        ))
        ...
        db.create_table('main_propertyleaseterm', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('lease_term', self.gf('django.db.models.fields.CharField')(null=True, blank=True, max_length=3)),
        ))
        ...
        db.create_table('main_propertyleasetype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('lease_type', self.gf('django.db.models.fields.CharField')(default='BTB', max_length=3)),
        ))
        db.send_create_signal('main', ['PropertyLeaseType'])

        # Deleting field 'Property.lease_type'
        db.delete_column('main_property', 'lease_type')
    ...
    def backwards(self, orm):
        ...
        db.add_column('main_property', 'lease_type',
                      self.gf('django.db.models.fields.CharField')(default='BTB', max_length=3),
                      keep_default=False)
    ...
    models = {
        ...
        'main.article': {
            ...
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['main.Tag']", 'blank': 'True', 'null': 'True', 'symmetrical': 'False'}),
        ...
        'main.propertyleasestart': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lease_start': ('django.db.models.fields.CharField', [], {'null': 'True', 'blank': 'True', 'max_length': '3'})
        },
        'main.propertyleaseterm': {
            'Meta': {'object_name': 'PropertyLeaseTerm'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lease_term': ('django.db.models.fields.CharField', [], {'null': 'True', 'blank': 'True', 'max_length': '3'})
        },
        'main.propertyleasetype': {
            'Meta': {'object_name': 'PropertyLeaseType'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lease_type': ('django.db.models.fields.CharField', [], {'default': "'BTB'", 'max_length': '3'})
        },
