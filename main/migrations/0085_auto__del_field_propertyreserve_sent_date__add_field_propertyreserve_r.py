...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('main_propertyreserve', 'sent_date')

        # Adding field 'PropertyReserve.reserve_date'
        db.add_column('main_propertyreserve', 'reserve_date',
                      self.gf('django.db.models.fields.DateField')(blank=True, auto_now_add=True, default=datetime.datetime(2014, 3, 18, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PropertyReserve.sent_date'
        db.add_column('main_propertyreserve', 'sent_date',
                      self.gf('django.db.models.fields.DateField')(blank=True, auto_now_add=True, default=datetime.datetime(2014, 3, 18, 0, 0)),
                      keep_default=False)

        # Deleting field 'PropertyReserve.reserve_date'
        db.delete_column('main_propertyreserve', 'reserve_date')
