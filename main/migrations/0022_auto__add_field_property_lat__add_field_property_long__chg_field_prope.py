...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('main_property', 'lat',
                      self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=3, blank=True, null=True),
                      keep_default=False)

        # Adding field 'Property.long'
        db.add_column('main_property', 'long',
                      self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=3, blank=True, null=True),
                      keep_default=False)


        # Changing field 'Property.video_link'
        db.alter_column('main_property', 'video_link', self.gf('django.db.models.fields.CharField')(null=True, max_length=300))

    def backwards(self, orm):
        # Deleting field 'Property.lat'
        db.delete_column('main_property', 'lat')

        # Deleting field 'Property.long'
        db.delete_column('main_property', 'long')


        # Changing field 'Property.video_link'
        db.alter_column('main_property', 'video_link', self.gf('django.db.models.fields.CharField')(default=0, max_length=300))
    ...
    models = {
        ...
        'main.property': {
            ...
            'amenities': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['main.Amenity']", 'symmetrical': 'False'}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'null': 'True', 'max_length': '100'}),
            'lat': ('django.db.models.fields.DecimalField', [], {'max_digits': '8', 'decimal_places': '3', 'blank': 'True', 'null': 'True'}),
            'long': ('django.db.models.fields.DecimalField', [], {'max_digits': '8', 'decimal_places': '3', 'blank': 'True', 'null': 'True'}),
