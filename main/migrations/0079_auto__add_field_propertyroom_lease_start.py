...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('main_propertyroom', 'lease_start',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['main.PropertyLeaseStart']),
                      keep_default=False)
    ...
    models = {
        ...
        'main.propertyroom': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lease_start': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'to': "orm['main.PropertyLeaseStart']"}),
