...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contact.property'
        db.add_column('main_contact', 'property',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=24, to=orm['main.Property']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contact.property'
        db.delete_column('main_contact', 'property_id')
    ...
    models = {
        ...
        'main.property': {
            ...
            'lease_start': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'to': "orm['main.PropertyLeaseStart']", 'symmetrical': 'False', 'blank': 'True'}),
