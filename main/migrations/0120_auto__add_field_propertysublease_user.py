...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PropertySublease.user'
        db.add_column('main_propertysublease', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PropertySublease.user'
        db.delete_column('main_propertysublease', 'user_id')
