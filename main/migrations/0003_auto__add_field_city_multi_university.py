...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'City.multi_university'
        db.add_column('main_city', 'multi_university',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'City.multi_university'
        db.delete_column('main_city', 'multi_university')
