...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('main_city', (
            ...
            ('link', self.gf('django.db.models.fields.CharField')(null=True, max_length=100, blank=True)),
        ))
        db.send_create_signal('main', ['City'])

        # Adding field 'School.link'
        db.add_column('main_school', 'link',
                      self.gf('django.db.models.fields.CharField')(null=True, max_length=100, blank=True),
                      keep_default=False)


        # Changing field 'School.mascot'
        db.alter_column('main_school', 'mascot', self.gf('django.db.models.fields.CharField')(null=True, max_length=50))

    def backwards(self, orm):
        # Deleting model 'City'
        db.delete_table('main_city')

        # Deleting field 'School.link'
        db.delete_column('main_school', 'link')


        # User chose to not deal with backwards NULL issues for 'School.mascot'
        raise RuntimeError("Cannot reverse this migration. 'School.mascot' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'School.mascot'
        db.alter_column('main_school', 'mascot', self.gf('django.db.models.fields.CharField')(max_length=50))
