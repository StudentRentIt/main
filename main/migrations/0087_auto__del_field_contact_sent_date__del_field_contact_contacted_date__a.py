...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Rename field 'Contact.contacted_date'
    ...
    def backwards(self, orm):
        ...
        db.add_column('main_contact', 'sent_date',
                      self.gf('django.db.models.fields.DateField')(blank=True, auto_now_add=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Contact.contacted_date'
        raise RuntimeError("Cannot reverse this migration. 'Contact.contacted_date' and its values cannot be restored.")
