...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'main.propertyleasestart': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lease_start': ('django.db.models.fields.CharField', [], {'max_length': '3', 'blank': 'True', 'null': 'True'})
        },
        'main.propertyleaseterm': {
            'Meta': {'object_name': 'PropertyLeaseTerm'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lease_term': ('django.db.models.fields.CharField', [], {'max_length': '3', 'blank': 'True', 'null': 'True'})
        },
