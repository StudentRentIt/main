...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('main_propertyreserve', 'email',
                      self.gf('django.db.models.fields.CharField')(default='default@gmail.com', max_length=80),
                      keep_default=False)


        # Changing field 'PropertyReserve.user'
        db.alter_column('main_propertyreserve', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'PropertyReserve.user'
        raise RuntimeError("Cannot reverse this migration. 'PropertyReserve.user' and its values cannot be restored.")
        ...
        # User chose to not deal with backwards NULL issues for 'Contact.property'
        raise RuntimeError("Cannot reverse this migration. 'Contact.property' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Contact.property'
        db.alter_column('main_contact', 'property_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Property']))
    ...
    models = {
        ...
        'main.article': {
            ...
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['main.Tag']", 'null': 'True', 'blank': 'True'}),
        ...
        'main.property': {
            ...
            'amenities': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['main.Amenity']", 'null': 'True', 'blank': 'True'}),
            ...
            'lease_term': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['main.PropertyLeaseTerm']", 'null': 'True', 'blank': 'True'}),
            'lease_type': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['main.PropertyLeaseType']", 'null': 'True', 'blank': 'True'}),
