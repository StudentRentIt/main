...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PropertyLeaseType.lease_type_short'
        db.add_column('main_propertyleasetype', 'lease_type_short',
                      self.gf('django.db.models.fields.CharField')(max_length=5, blank=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PropertyLeaseType.lease_type_short'
        db.delete_column('main_propertyleasetype', 'lease_type_short')
    ...
    models = {
        ...
        'main.property': {
            ...
            'lease_start': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'blank': 'True', 'null': 'True', 'to': "orm['main.PropertyLeaseStart']"}),
        ...
        'main.propertyleasetype': {
            ...
            'lease_type_short': ('django.db.models.fields.CharField', [], {'max_length': '5', 'blank': 'True', 'null': 'True'})
        },
