...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('main_customuser', 'user_type', self.gf('django.db.models.fields.CharField')(null=True, max_length=30))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'CustomUser.user_type'
        raise RuntimeError("Cannot reverse this migration. 'CustomUser.user_type' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'CustomUser.user_type'
        db.alter_column('main_customuser', 'user_type', self.gf('django.db.models.fields.CharField')(max_length=30))
    ...
    models = {
        ...
        'main.property': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.CustomUser']", 'null': 'True'}),
