...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Roommate.create_date'
        db.add_column('main_roommate', 'create_date',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True, default=datetime.datetime(2014, 2, 8, 0, 0)),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Roommate.create_date'
        db.delete_column('main_roommate', 'create_date')
