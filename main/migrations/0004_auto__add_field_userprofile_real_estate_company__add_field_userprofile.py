...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.real_estate_company'
        db.add_column('main_userprofile', 'real_estate_company',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['realestate.Company'], null=True),
                      keep_default=False)

        # Adding field 'UserProfile.phone_number'
        db.add_column('main_userprofile', 'phone_number',
                      self.gf('localflavor.us.models.PhoneNumberField')(blank=True, null=True, max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.real_estate_company'
        db.delete_column('main_userprofile', 'real_estate_company_id')

        # Deleting field 'UserProfile.phone_number'
        db.delete_column('main_userprofile', 'phone_number')
    ...
    models = {
        ...
        'main.userprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'phone_number': ('localflavor.us.models.PhoneNumberField', [], {'blank': 'True', 'null': 'True', 'max_length': '20'}),
