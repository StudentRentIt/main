...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PropertySublease.contact'
        db.delete_column('main_propertysublease', 'contact')

        # Adding field 'PropertySublease.contact_email'
        db.add_column('main_propertysublease', 'contact_email',
                      self.gf('django.db.models.fields.EmailField')(default='support@studentrentit.com', max_length=60),
                      keep_default=False)

        # Adding field 'PropertySublease.contact_phone'
        db.add_column('main_propertysublease', 'contact_phone',
                      self.gf('localflavor.us.models.PhoneNumberField')(default=1231231234, max_length=20),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'PropertySublease.contact'
        raise RuntimeError("Cannot reverse this migration. 'PropertySublease.contact' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'PropertySublease.contact'
        db.add_column('main_propertysublease', 'contact',
                      self.gf('django.db.models.fields.CharField')(max_length=60),
                      keep_default=False)

        # Deleting field 'PropertySublease.contact_email'
        db.delete_column('main_propertysublease', 'contact_email')

        # Deleting field 'PropertySublease.contact_phone'
        db.delete_column('main_propertysublease', 'contact_phone')
    ...
    models = {
        ...
        'main.package': {
            ...
            'services': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['main.Service']", 'null': 'True', 'symmetrical': 'False', 'blank': 'True'}),
