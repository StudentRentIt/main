...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('main_propertyreserve', 'phone_number',
                      self.gf('localflavor.us.models.PhoneNumberField')(null=True, max_length=20),
                      keep_default=False)
    ...
    models = {
        ...
        'main.article': {
            ...
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'to': "orm['main.Tag']", 'symmetrical': 'False', 'null': 'True'}),
        ...
        'main.package': {
            ...
            'services': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'to': "orm['main.Service']", 'symmetrical': 'False', 'null': 'True'}),
        ...
        'main.property': {
            ...
            'amenities': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'to': "orm['main.Amenity']", 'symmetrical': 'False', 'null': 'True'}),
            ...
            'lease_term': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'to': "orm['main.PropertyLeaseTerm']", 'symmetrical': 'False', 'null': 'True'}),
            'lease_type': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'to': "orm['main.PropertyLeaseType']", 'symmetrical': 'False', 'null': 'True'}),
