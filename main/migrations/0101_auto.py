...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing M2M table for field package on 'Payment'
        db.delete_table(db.shorten_name('main_payment_package'))


    def backwards(self, orm):
        # Adding M2M table for field package on 'Payment'
        m2m_table_name = db.shorten_name('main_payment_package')
        ...
        db.create_unique(m2m_table_name, ['payment_id', 'package_id'])
