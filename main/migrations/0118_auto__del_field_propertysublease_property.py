...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PropertySublease.property'
        db.delete_column('main_propertysublease', 'property_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'PropertySublease.property'
        raise RuntimeError("Cannot reverse this migration. 'PropertySublease.property' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'PropertySublease.property'
        db.add_column('main_propertysublease', 'property',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Property']),
                      keep_default=False)
    ...
    models = {
        ...
        'main.article': {
            ...
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['main.Tag']", 'blank': 'True', 'null': 'True'}),
        ...
        'main.contact': {
            ...
            'property': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'blank': 'True', 'to': "orm['main.Property']"}),
        ...
        'main.package': {
            ...
            'services': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['main.Service']", 'blank': 'True', 'null': 'True'}),
        ...
        'main.property': {
            ...
            'amenities': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['main.Amenity']", 'blank': 'True', 'null': 'True'}),
            ...
            'lease_term': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['main.PropertyLeaseTerm']", 'blank': 'True', 'null': 'True'}),
            'lease_type': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['main.PropertyLeaseType']", 'blank': 'True', 'null': 'True'}),
            'long': ('django.db.models.fields.DecimalField', [], {'decimal_places': '6', 'max_digits': '12', 'blank': 'True', 'null': 'True'}),
            'package': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'blank': 'True', 'to': "orm['main.Package']"}),
            'school': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.School']"}),
            'services': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['main.Service']", 'blank': 'True', 'null': 'True'}),
        ...
        'main.propertysublease': {
            'Meta': {'object_name': 'PropertySublease', 'ordering': "['-id']"},
            'contact_email': ('django.db.models.fields.EmailField', [], {'max_length': '60'}),
