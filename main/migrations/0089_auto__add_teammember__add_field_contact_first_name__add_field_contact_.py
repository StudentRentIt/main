...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('main_teammember', (
            ...
            ('picture', self.gf('django.db.models.fields.files.ImageField')(null=True, max_length=100, blank=True)),
        ))
        db.send_create_signal('main', ['TeamMember'])

        # Adding field 'Contact.first_name'
        db.add_column('main_contact', 'first_name',
                      self.gf('django.db.models.fields.CharField')(default='none', max_length=50),
                      keep_default=False)

        # Adding field 'Contact.last_name'
        db.add_column('main_contact', 'last_name',
                      self.gf('django.db.models.fields.CharField')(default='none', max_length=50),
                      keep_default=False)

        # Deleting field 'PropertySchedule.name'
        db.delete_column('main_propertyschedule', 'name')

        # Adding field 'PropertySchedule.first_name'
        db.add_column('main_propertyschedule', 'first_name',
                      self.gf('django.db.models.fields.CharField')(default='none', max_length=50),
                      keep_default=False)

        # Adding field 'PropertySchedule.last_name'
        db.add_column('main_propertyschedule', 'last_name',
                      self.gf('django.db.models.fields.CharField')(default='none', max_length=50),
                      keep_default=False)
        ...
        # Adding field 'PropertyReserve.first_name'
        db.add_column('main_propertyreserve', 'first_name',
                      self.gf('django.db.models.fields.CharField')(default='none', max_length=50),
                      keep_default=False)

        # Adding field 'PropertyReserve.last_name'
        db.add_column('main_propertyreserve', 'last_name',
                      self.gf('django.db.models.fields.CharField')(default='none', max_length=50),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('main_contact', 'first_name')

        # Deleting field 'Contact.last_name'
        db.delete_column('main_contact', 'last_name')


        # User chose to not deal with backwards NULL issues for 'PropertySchedule.name'
        raise RuntimeError("Cannot reverse this migration. 'PropertySchedule.name' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'PropertySchedule.name'
        db.add_column('main_propertyschedule', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=50),
                      keep_default=False)

        # Deleting field 'PropertySchedule.first_name'
        db.delete_column('main_propertyschedule', 'first_name')

        # Deleting field 'PropertySchedule.last_name'
        db.delete_column('main_propertyschedule', 'last_name')


        # User chose to not deal with backwards NULL issues for 'PropertyReserve.name'
        raise RuntimeError("Cannot reverse this migration. 'PropertyReserve.name' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'PropertyReserve.name'
        db.add_column('main_propertyreserve', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=50),
                      keep_default=False)

        # Deleting field 'PropertyReserve.first_name'
        db.delete_column('main_propertyreserve', 'first_name')

        # Deleting field 'PropertyReserve.last_name'
        db.delete_column('main_propertyreserve', 'last_name')
    ...
    models = {
        ...
        'main.article': {
            ...
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'to': "orm['main.Tag']", 'symmetrical': 'False', 'blank': 'True'}),
        ...
        'main.package': {
            ...
            'services': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'to': "orm['main.Service']", 'symmetrical': 'False', 'blank': 'True'}),
        ...
        'main.property': {
            ...
            'amenities': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'to': "orm['main.Amenity']", 'symmetrical': 'False', 'blank': 'True'}),
            ...
            'lease_term': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'to': "orm['main.PropertyLeaseTerm']", 'symmetrical': 'False', 'blank': 'True'}),
            'lease_type': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'to': "orm['main.PropertyLeaseType']", 'symmetrical': 'False', 'blank': 'True'}),
        ...
        'main.propertyimage': {
            ...
            'caption': ('django.db.models.fields.CharField', [], {'null': 'True', 'max_length': '40', 'blank': 'True'}),
