...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PropertyLeaseTerm.lease_term_short'
        db.add_column('main_propertyleaseterm', 'lease_term_short',
                      self.gf('django.db.models.fields.CharField')(null=True, max_length=5, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column('main_propertyleasetype', 'lease_type_short',
                      self.gf('django.db.models.fields.CharField')(blank=True, max_length=5, null=True),
                      keep_default=False)

        # Deleting field 'PropertyLeaseTerm.lease_term_short'
        db.delete_column('main_propertyleaseterm', 'lease_term_short')
