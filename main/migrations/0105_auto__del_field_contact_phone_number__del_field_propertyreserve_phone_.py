...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Contact.phone_number'
        db.delete_column('main_contact', 'phone_number')

        # Deleting field 'PropertyReserve.phone_number'
        db.delete_column('main_propertyreserve', 'phone_number')


    def backwards(self, orm):
        # Adding field 'Contact.phone_number'
        db.add_column('main_contact', 'phone_number',
                      self.gf('localflavor.us.models.PhoneNumberField')(max_length=20, null=True),
                      keep_default=False)

        # Adding field 'PropertyReserve.phone_number'
        db.add_column('main_propertyreserve', 'phone_number',
                      self.gf('localflavor.us.models.PhoneNumberField')(max_length=20, null=True),
                      keep_default=False)
    ...
    models = {
        ...
        'main.article': {
            ...
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['main.Tag']", 'null': 'True', 'blank': 'True', 'symmetrical': 'False'}),
        ...
        'main.package': {
            ...
            'services': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['main.Service']", 'null': 'True', 'blank': 'True', 'symmetrical': 'False'}),
        ...
        'main.property': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lat': ('django.db.models.fields.DecimalField', [], {'max_digits': '12', 'null': 'True', 'blank': 'True', 'decimal_places': '6'}),
            'lease_term': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['main.PropertyLeaseTerm']", 'null': 'True', 'blank': 'True', 'symmetrical': 'False'}),
            'lease_type': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['main.PropertyLeaseType']", 'null': 'True', 'blank': 'True', 'symmetrical': 'False'}),
            'long': ('django.db.models.fields.DecimalField', [], {'max_digits': '12', 'null': 'True', 'blank': 'True', 'decimal_places': '6'}),
