...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('main_propertyimage', (
            ...
            ('property', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Property'], related_name='images')),
    ...
    models = {
        ...
        'main.property': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'images': ('topnotchdev.files_widget.fields.ImagesField', [], {'null': 'True'}),
