...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Contact.contact_date'
        db.rename_column('main_contact', 'contact_date', 'contacted_date')


    def backwards(self, orm):
        # Adding field 'Contact.contacted_date'
        db.rename_column('main_contact', 'contacted_date', 'contact_date')
    ...
    models = {
        ...
        'main.article': {
            ...
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['main.Tag']", 'null': 'True', 'symmetrical': 'False', 'blank': 'True'}),
        ...
        'main.contact': {
            ...
            'contacted_date': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
        ...
        'main.property': {
            ...
            'amenities': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['main.Amenity']", 'null': 'True', 'symmetrical': 'False', 'blank': 'True'}),
            ...
            'lease_term': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['main.PropertyLeaseTerm']", 'null': 'True', 'symmetrical': 'False', 'blank': 'True'}),
            'lease_type': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['main.PropertyLeaseType']", 'null': 'True', 'symmetrical': 'False', 'blank': 'True'}),
