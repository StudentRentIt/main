...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Deal.location'
        db.delete_column('main_deal', 'location')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Deal.location'
        raise RuntimeError("Cannot reverse this migration. 'Deal.location' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Deal.location'
        db.add_column('main_deal', 'location',
