...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('main_event', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(null=True, max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Roommate.image'
        db.add_column('main_roommate', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(null=True, max_length=100, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('main_event', 'image')

        # Deleting field 'Roommate.image'
        db.delete_column('main_roommate', 'image')
    ...
    models = {
        ...
        'main.property': {
            ...
            'lease_start': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['main.PropertyLeaseStart']", 'null': 'True', 'blank': 'True'}),
            ...
            'video_link': ('django.db.models.fields.CharField', [], {'null': 'True', 'max_length': '300', 'blank': 'True'}),
