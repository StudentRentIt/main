...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Deal.image'
        db.add_column('main_deal', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Deal.image'
        db.delete_column('main_deal', 'image')
    ...
    models = {
        ...
        'main.article': {
            ...
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['main.Tag']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'}),
        ...
        'main.property': {
            ...
            'amenities': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['main.Amenity']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'}),
            ...
            'lease_start': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['main.PropertyLeaseStart']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'}),
            'lease_term': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['main.PropertyLeaseTerm']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'}),
            'lease_type': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['main.PropertyLeaseType']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'}),
