...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('main_propertyreserve', (
            ...
            ('felony', self.gf('django.db.models.fields.BooleanField')()),
            ('evicted', self.gf('django.db.models.fields.BooleanField')()),
            ('credit', self.gf('django.db.models.fields.BooleanField')()),
            ('agree', self.gf('django.db.models.fields.BooleanField')()),
        ))
        db.send_create_signal('main', ['PropertyReserve'])

        # Adding field 'PropertyFavorite.note'
        db.add_column('main_propertyfavorite', 'note',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'PropertyFavorite.note'
        db.delete_column('main_propertyfavorite', 'note')
