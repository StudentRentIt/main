...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Property.lease_type'
        db.alter_column('main_property', 'lease_type', self.gf('django.db.models.fields.CharField')(max_length=3))

    def backwards(self, orm):

        # Changing field 'Property.lease_type'
        db.alter_column('main_property', 'lease_type', self.gf('django.db.models.fields.CharField')(null=True, max_length=3))
    ...
    models = {
        ...
        'main.property': {
            ...
            'lease_type': ('django.db.models.fields.CharField', [], {'max_length': '3', 'default': "'BTB'"}),
