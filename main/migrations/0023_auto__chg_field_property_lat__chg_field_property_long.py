...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Property.lat'
        db.alter_column('main_property', 'lat', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=6))

        # Changing field 'Property.long'
        db.alter_column('main_property', 'long', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=6))

    def backwards(self, orm):

        # Changing field 'Property.lat'
        db.alter_column('main_property', 'lat', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=3))

        # Changing field 'Property.long'
        db.alter_column('main_property', 'long', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=3))
