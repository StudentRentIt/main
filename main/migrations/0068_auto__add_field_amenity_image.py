...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Amenity.image'
        db.add_column('main_amenity', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(null=True, max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Amenity.image'
        db.delete_column('main_amenity', 'image')
    ...
    models = {
        ...
        'main.property': {
            ...
            'lease_start': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'symmetrical': 'False', 'blank': 'True', 'to': "orm['main.PropertyLeaseStart']"}),
