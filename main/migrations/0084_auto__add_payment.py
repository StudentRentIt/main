...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('main_payment', (
            ...
            ('property', self.gf('django.db.models.fields.related.ForeignKey')(null=True, blank=True, to=orm['main.Property'])),
    ...
    models = {
        ...
        'main.package': {
            ...
            'services': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'symmetrical': 'False', 'blank': 'True', 'to': "orm['main.Service']"}),
