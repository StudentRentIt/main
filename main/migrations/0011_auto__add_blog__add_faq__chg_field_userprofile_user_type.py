...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'FAQ'
        db.create_table(u'main_faq', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('question', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('answer', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'main', ['FAQ'])


        # Changing field 'UserProfile.user_type'
        db.alter_column(u'main_userprofile', 'user_type', self.gf('django.db.models.fields.CharField')(max_length=30))
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'FAQ'
        db.delete_table(u'main_faq')


        # Changing field 'UserProfile.user_type'
        db.alter_column(u'main_userprofile', 'user_type', self.gf('django.db.models.fields.CharField')(max_length=100))
