...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PropertyLeaseTerm.order'
        db.add_column('main_propertyleaseterm', 'order',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'PropertyLeaseStart.order'
        db.add_column('main_propertyleasestart', 'order',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PropertyLeaseTerm.order'
        db.delete_column('main_propertyleaseterm', 'order')

        # Deleting field 'PropertyLeaseStart.order'
        db.delete_column('main_propertyleasestart', 'order')
    ...
    models = {
        ...
        'main.property': {
            ...
            'lease_start': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'symmetrical': 'False', 'null': 'True', 'to': "orm['main.PropertyLeaseStart']"}),
