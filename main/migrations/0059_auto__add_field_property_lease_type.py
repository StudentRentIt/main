...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('main_property', 'lease_type',
                      self.gf('django.db.models.fields.CharField')(blank=True, default='BTB', null=True, max_length=3),
                      keep_default=False)
    ...
    models = {
        ...
        'main.property': {
            ...
            'lease_type': ('django.db.models.fields.CharField', [], {'blank': 'True', 'default': "'BTB'", 'null': 'True', 'max_length': '3'}),
