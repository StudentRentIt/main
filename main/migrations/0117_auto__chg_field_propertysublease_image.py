...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PropertySublease.image'
        db.alter_column('main_propertysublease', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'PropertySublease.image'
        raise RuntimeError("Cannot reverse this migration. 'PropertySublease.image' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'PropertySublease.image'
        db.alter_column('main_propertysublease', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
    ...
    models = {
        ...
        'main.article': {
            ...
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'blank': 'True', 'null': 'True', 'to': "orm['main.Tag']"}),
        ...
        'main.package': {
            ...
            'services': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'blank': 'True', 'null': 'True', 'to': "orm['main.Service']"}),
        ...
        'main.property': {
            ...
            'lease_term': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'blank': 'True', 'null': 'True', 'to': "orm['main.PropertyLeaseTerm']"}),
            'lease_type': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'blank': 'True', 'null': 'True', 'to': "orm['main.PropertyLeaseType']"}),
        ...
        'main.propertysublease': {
            'Meta': {'ordering': "['-id']", 'object_name': 'PropertySublease'},
