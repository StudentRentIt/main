...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PropertySublease.property'
        db.add_column('main_propertysublease', 'property',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=24, to=orm['main.Property']),
                      keep_default=False)
    ...
    models = {
        ...
        'main.package': {
            ...
            'services': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['main.Service']", 'null': 'True', 'blank': 'True'}),
