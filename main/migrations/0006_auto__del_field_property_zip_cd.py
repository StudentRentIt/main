...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Property.zip_cd'
        raise RuntimeError("Cannot reverse this migration. 'Property.zip_cd' and its values cannot be restored.")
