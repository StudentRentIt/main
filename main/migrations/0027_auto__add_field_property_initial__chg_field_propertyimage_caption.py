...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Property.initial'
        db.add_column('main_property', 'initial',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


        # Changing field 'PropertyImage.caption'
        db.alter_column('main_propertyimage', 'caption', self.gf('django.db.models.fields.CharField')(null=True, max_length=40))

    def backwards(self, orm):
        # Deleting field 'Property.initial'
        db.delete_column('main_property', 'initial')


        # Changing field 'PropertyImage.caption'
        db.alter_column('main_propertyimage', 'caption', self.gf('django.db.models.fields.CharField')(max_length=40))
    ...
    models = {
        ...
        'main.property': {
            ...
            'amenities': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['main.Amenity']", 'null': 'True', 'symmetrical': 'False'}),
