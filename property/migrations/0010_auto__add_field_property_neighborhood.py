...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Property.neighborhood'
        db.add_column('property_property', 'neighborhood',
                      self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['school.Neighborhood'], blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Property.neighborhood'
        db.delete_column('property_property', 'neighborhood_id')
    ...
    models = {
        ...
        'property.propertyimage': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'null': 'True', 'max_length': '100', 'blank': 'True'}),
            'image_link': ('django.db.models.fields.URLField', [], {'null': 'True', 'max_length': '200', 'blank': 'True'}),
