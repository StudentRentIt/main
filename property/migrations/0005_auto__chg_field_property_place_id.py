...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('property_property', 'place_id', self.gf('django.db.models.fields.CharField')(null=True, max_length=30))

    def backwards(self, orm):

        # Changing field 'Property.place_id'
        db.alter_column('property_property', 'place_id', self.gf('django.db.models.fields.CharField')(null=True, max_length=80))
