...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'PropertyHide'
        db.delete_table('property_propertyhide')
    ...
    def backwards(self, orm):
        # Adding model 'PropertyHide'
        db.create_table('property_propertyhide', (
            ('property', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['property.Property'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('property', ['PropertyHide'])
