...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'PropertyReview'
        db.delete_table('property_propertyreview')

        # Deleting field 'Property.rating'
        db.delete_column('property_property', 'rating')


        # Changing field 'Property.place_id'
        db.alter_column('property_property', 'place_id', self.gf('django.db.models.fields.CharField')(max_length=80, null=True))

    def backwards(self, orm):
        # Adding model 'PropertyReview'
        db.create_table('property_propertyreview', (
            ('text', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True)),
            ('property', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['property.Property'])),
            ('author_url', self.gf('django.db.models.fields.CharField')(max_length=80, null=True)),
            ('time', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('rating', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('author_name', self.gf('django.db.models.fields.CharField')(max_length=80, null=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('property', ['PropertyReview'])
        ...
        # Changing field 'Property.place_id'
        db.alter_column('property_property', 'place_id', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
    ...
    models = {
        ...
        'property.package': {
            ...
            'services': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'null': 'True', 'to': "orm['property.Service']", 'blank': 'True'}),
        ...
        'property.property': {
            ...
            'amenities': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'null': 'True', 'to': "orm['property.Amenity']", 'blank': 'True'}),
            ...
            'lease_term': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'null': 'True', 'to': "orm['property.PropertyLeaseTerm']", 'blank': 'True'}),
            'lease_type': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'null': 'True', 'to': "orm['property.PropertyLeaseType']", 'blank': 'True'}),
            ...
            'place_id': ('django.db.models.fields.CharField', [], {'max_length': '80', 'null': 'True', 'blank': 'True'}),
