...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Property.real_estate_company'
        db.add_column('property_property', 'real_estate_company',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['realestate.Company'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Property.real_estate_company'
        db.delete_column('property_property', 'real_estate_company_id')
