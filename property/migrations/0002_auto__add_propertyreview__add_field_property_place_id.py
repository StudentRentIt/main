...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('property_propertyreview', (
            ...
            ('author_name', self.gf('django.db.models.fields.CharField')(null=True, max_length=80)),
            ('author_url', self.gf('django.db.models.fields.CharField')(null=True, max_length=80)),
            ('rating', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('text', self.gf('django.db.models.fields.CharField')(null=True, max_length=1000)),
            ('time', self.gf('django.db.models.fields.IntegerField')(null=True)),
        ))
        db.send_create_signal('property', ['PropertyReview'])

        # Adding field 'Property.place_id'
        db.add_column('property_property', 'place_id',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Property.place_id'
        db.delete_column('property_property', 'place_id')
    ...
    models = {
        ...
        'property.property': {
            ...
            'place_id': ('django.db.models.fields.CharField', [], {'blank': 'True', 'null': 'True', 'max_length': '100'}),
        ...
        'property.propertyreview': {
            'Meta': {'ordering': "['-time']", 'object_name': 'PropertyReview'},
            'author_name': ('django.db.models.fields.CharField', [], {'null': 'True', 'max_length': '80'}),
            'author_url': ('django.db.models.fields.CharField', [], {'null': 'True', 'max_length': '80'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'property': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['property.Property']"}),
            'rating': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'text': ('django.db.models.fields.CharField', [], {'null': 'True', 'max_length': '1000'}),
