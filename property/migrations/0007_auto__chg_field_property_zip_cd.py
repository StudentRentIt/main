...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Property.zip_cd'
        db.alter_column('property_property', 'zip_cd', self.gf('django.db.models.fields.CharField')(null=True, max_length=15))

    def backwards(self, orm):

        # Changing field 'Property.zip_cd'
        db.alter_column('property_property', 'zip_cd', self.gf('django.db.models.fields.CharField')(default='12345', max_length=15))
