...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Apartment.city'
        db.add_column('scrape_apartment', 'city',
                      self.gf('django.db.models.fields.CharField')(max_length=30, default='none'),
                      keep_default=False)

        # Adding field 'Apartment.state'
        db.add_column('scrape_apartment', 'state',
                      self.gf('django.db.models.fields.CharField')(max_length=2, default='na'),
                      keep_default=False)
