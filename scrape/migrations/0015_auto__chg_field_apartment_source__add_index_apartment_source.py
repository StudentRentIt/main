...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Apartment.source' to match new field type.
        db.rename_column('scrape_apartment', 'source', 'source_id')
        # Changing field 'Apartment.source'
        db.alter_column('scrape_apartment', 'source_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['scrape.Source']))
        # Adding index on 'Apartment', fields ['source']
        db.create_index('scrape_apartment', ['source_id'])


    def backwards(self, orm):
        # Removing index on 'Apartment', fields ['source']
        db.delete_index('scrape_apartment', ['source_id'])


        # Renaming column for 'Apartment.source' to match new field type.
        db.rename_column('scrape_apartment', 'source_id', 'source')
        # Changing field 'Apartment.source'
        db.alter_column('scrape_apartment', 'source', self.gf('django.db.models.fields.CharField')(max_length=1))
