...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ScrapeLog.date'
        db.alter_column('scrape_scrapelog', 'date', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
        # Deleting field 'ApartmentFeatures.type'
        db.delete_column('scrape_apartmentfeatures', 'type')


    def backwards(self, orm):

        # Changing field 'ScrapeLog.date'
        db.alter_column('scrape_scrapelog', 'date', self.gf('django.db.models.fields.DateField')())

        # User chose to not deal with backwards NULL issues for 'ApartmentFeatures.type'
        raise RuntimeError("Cannot reverse this migration. 'ApartmentFeatures.type' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'ApartmentFeatures.type'
        db.add_column('scrape_apartmentfeatures', 'type',
    ...
    models = {
        ...
        'scrape.apartment': {
            ...
            'address': ('django.db.models.fields.CharField', [], {'blank': 'True', 'null': 'True', 'max_length': '80'}),
