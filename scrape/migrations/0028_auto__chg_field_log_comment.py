...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Log.comment'
        db.alter_column('scrape_log', 'comment', self.gf('django.db.models.fields.CharField')(null=True, max_length=70))

    def backwards(self, orm):

        # Changing field 'Log.comment'
        db.alter_column('scrape_log', 'comment', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
    ...
    models = {
        ...
        'scrape.log': {
            'Meta': {'ordering': "['-datetime']", 'object_name': 'Log'},
            ...
            'comment': ('django.db.models.fields.CharField', [], {'null': 'True', 'max_length': '70', 'blank': 'True'}),
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 2, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
