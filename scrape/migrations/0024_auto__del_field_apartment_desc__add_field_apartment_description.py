...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Apartment.desc'
        db.delete_column('scrape_apartment', 'desc')

        # Adding field 'Apartment.description'
        db.add_column('scrape_apartment', 'description',
                      self.gf('django.db.models.fields.TextField')(blank=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Apartment.desc'
        db.add_column('scrape_apartment', 'desc',
                      self.gf('django.db.models.fields.TextField')(blank=True, null=True),
                      keep_default=False)

        # Deleting field 'Apartment.description'
        db.delete_column('scrape_apartment', 'description')
    ...
    models = {
        ...
        'scrape.log': {
            'Meta': {'object_name': 'Log', 'ordering': "['-date']"},
            ...
            'comment': ('django.db.models.fields.CharField', [], {'blank': 'True', 'null': 'True', 'max_length': '50'}),
