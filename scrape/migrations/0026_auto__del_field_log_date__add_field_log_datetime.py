...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('scrape_log', 'date')

        # Adding field 'Log.datetime'
        db.add_column('scrape_log', 'datetime',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 7, 1, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Log.date'
        db.add_column('scrape_log', 'date',
                      self.gf('django.db.models.fields.DateField')(blank=True, auto_now_add=True, default=datetime.datetime(2014, 7, 1, 0, 0)),
                      keep_default=False)

        # Deleting field 'Log.datetime'
        db.delete_column('scrape_log', 'datetime')
