...
class Migration(SchemaMigration):
  ...
  def forwards(self, orm):
    # Deleting field 'Article.test_field'
    db.delete_column('blog_article', 'test_field')


  def backwards(self, orm):
    # Adding field 'Article.test_field'
    db.add_column('blog_article', 'test_field',
  ...
  models = {
    ...
    'blog.article': {
      ...
      'heading': ('django.db.models.fields.CharField', [], {'null': 'True', 'max_length': '200', 'blank': 'True'}),
      'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
      ...
      'school': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'to': "orm['school.School']", 'blank': 'True'}),
      'sponsored': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
      'tags': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'to': "orm['blog.Tag']", 'blank': 'True', 'symmetrical': 'False'}),
    ...
    'property.package': {
      ...
      'services': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'to': "orm['property.Service']", 'blank': 'True', 'symmetrical': 'False'}),
    ...
    'property.property': {
      ...
      'amenities': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'to': "orm['property.Amenity']", 'blank': 'True', 'symmetrical': 'False'}),
      ...
      'lease_term': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'to': "orm['property.PropertyLeaseTerm']", 'blank': 'True', 'symmetrical': 'False'}),
      'lease_type': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'to': "orm['property.PropertyLeaseType']", 'blank': 'True', 'symmetrical': 'False'}),
