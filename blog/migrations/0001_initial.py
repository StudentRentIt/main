...
class Migration(SchemaMigration):
  ...
  def forwards(self, orm):
    ...
    db.create_table('blog_article', (
      ...
      ('school', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['school.School'], blank=True, null=True)),
  ...
  models = {
    ...
    'blog.article': {
      ...
      'school': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['school.School']", 'blank': 'True', 'null': 'True'}),
      'sponsored': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
      'tags': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['blog.Tag']", 'symmetrical': 'False', 'blank': 'True', 'null': 'True'}),
