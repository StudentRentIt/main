...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('report_propertyimpression', 'imp_property_package_id')


    def backwards(self, orm):
        # Adding field 'PropertyImpression.imp_property_package'
        db.add_column('report_propertyimpression', 'imp_property_package',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['property.Package'], null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'property.package': {
            ...
            'services': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'null': 'True', 'blank': 'True', 'to': "orm['property.Service']"}),
        ...
        'property.property': {
            ...
            'amenities': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'null': 'True', 'blank': 'True', 'to': "orm['property.Amenity']"}),
            ...
            'lease_term': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'null': 'True', 'blank': 'True', 'to': "orm['property.PropertyLeaseTerm']"}),
            'lease_type': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'null': 'True', 'blank': 'True', 'to': "orm['property.PropertyLeaseType']"}),
            ...
            'real_estate_company': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['realestate.Company']", 'null': 'True', 'blank': 'True'}),
        ...
        'realestate.company': {
            ...
            'default_school': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['school.School']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
